  ...
  return (
    <div className='w-screen h-screen bg-[#100821] flex items-center justify-center flex-col text-[#d5d2be]'>
      ...
      <div className='absolute w-full h-full flex flex-col items-center justify-center z-20'>
        <motion.h1 className='lg:text-[200px] text-[80px] font-bold' initial={{opacity:0,y:-60}} animate={{opacity:1,y:0}} transition={{duration:0.5}}>Luna Vista.</motion.h1>
        <motion.p className='text-xl w-full px-10 text-center tracking-wider' initial={{opacity:0}} animate={{opacity:1}} transition={{duration:0.5,delay:0.5}}>Your cosmic journey starts here | Align your path with the stars above</motion.p>
        <motion.div className='flex lg:flex-row flex-col items-center justify-center gap-12 text-2xl mt-20' initial={{opacity:0,y:50}} animate={{opacity:1,y:0}} transition={{duration:0.5,delay:1}}>
      ...
      <div className='absolute w-full h-full lg:flex flex-col text--[#d5d2be] items-start justify-between px-20 pt-20 text-[150px] z-10 hidden'>
